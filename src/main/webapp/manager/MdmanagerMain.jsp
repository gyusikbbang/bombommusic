    ...
    <div class="sidebar-links">
      ...
      <ul>
        ...
        <li class="tooltip-element" data-tooltip="1">
          <a href="managerMain.jsp"data-active="5">
            <div class="icon">
              <span class="material-symbols-outlined">
				person_search
				</span>
...
<div class="productinsert" id="productinsert" style="display:none" >
  ...
  <%@ include file="./mdproductProcess/product_Form.jsp" %>
</div>
 <div class="productupdate" id="productupdate" style="display:none">
 
   <jsp:include page="./mdproductProcess/productList.jsp?proCate=all"/>
  </div>
