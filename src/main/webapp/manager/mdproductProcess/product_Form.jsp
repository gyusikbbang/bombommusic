...
<body>
	<div id="inputform">
		<div class="panel shadow1  animate1">
			<form class="input-form " method="post"
				action="../manager/mdproductProcess/product_Pro.jsp"
				enctype="multipart/form-data" name="writeform" target="_blank">
				<h1 id="title-input">md 상품 추가</h1>
	...
	<input class="input " name="ProName"
						type="text" required placeholder="상품 이름" value="">
...
<input class="input " name="discount_rate"
						type="text" required placeholder="할인율" value=""> 
					...
					<script src="/BomBom/manager/js/file.js"></script>
						...
						class="input  animate3" name="ProInfo"
						type="text" required placeholder="상품 정보" value=""> <input
						class="input  animate3" name="ProStock"
						type="text" required placeholder="상품 재고" value=""> <input
						class="input  animate3"
						onchange="fileCheckaudio(this)" accept="audio/*" name="audio"
						type="file" required placeholder="오디오" value="">

				</fieldset>
				<input type="submit"
					class="input_form button  animate4"
					action="../manager/mdproductProcess/product_Pro.jsp" value="입력완료">
