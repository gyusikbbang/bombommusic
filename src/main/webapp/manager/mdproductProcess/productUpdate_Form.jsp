...
try{
	...
	mdPickDataBean product =  productProcess.getProduct(ProCode); 
%>
<html>
<head>
<title>상품수정</title>
...
<form method="post"  class="input-form " name="writeform" 
   action="/BomBom/manager/mdproductProcess/productUpdate_Pro.jsp" target="_blank" enctype="multipart/form-data">
   ...
   <script src= "../js/file.js"></script>
    ...
    <input class="input " name="discount_rate"
        ...
        <input type="text" class="input animated fadeInUp animate3" size="5" maxlength="2" name="ProStock" 
          ...
          <input type="submit" class="input_form button animated fadeInUp animate4" action="/BomBom/manager/mdproductProcess/productUpdate_Pro.jsp"  value="입력완료">
      </fieldset>
